...
The application traffic profiles generate protocol-native payloads for the
independent dual-stack responder and optional bidirectional client
transactions.
Live capture and transmission still
