...
def _parse_args(argv: Optional[List[str]]) -> argparse.Namespace:
    ...
    parser.add_argument("--frag-size", type=int, help="Fragment size in bytes (minimum 8; requires --frag)")
    parser.add_argument("--frag-mode", choices=["fixed", "random", "mixed"], default=None, help="Fragmentation mode: fixed, random size, or random fragment/no-fragment per logical send")
